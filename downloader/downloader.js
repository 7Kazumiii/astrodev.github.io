window.DownloadApi = {
	converter: {
		library: _ => `https://github.com/7Kazumiii/BD/master/Library/0BDFDB.plugin.js`,
		plugin: arg => `https://github.com/7Kazumiii/BD/master/Plugins/${arg}/${arg}.plugin.js`,
		theme: arg => `https://github.com/7Kazumiii/BD/master/Themes/${arg}/${arg}.theme.css`,
		url: arg => arg = arg.startsWith("https://") || arg.startsWith("http://") ? arg : `https://raw.githubusercontent.com/7Kazumiii/BD/master/${arg}`
	},
